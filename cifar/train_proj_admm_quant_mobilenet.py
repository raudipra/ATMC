...
from effnets2.mobilenetv2_dense import MobileNetV2 as CLdense
from effnets2.mobilenetv2_abcv2 import MobileNetV2 as CLabcv2
from effnets2.mobilenetv2_lr import MobileNetV2 as CLlr
...
parser.add_argument('--batch_size', type=int, default=128, help='input batch size for training (default: 256)')
